...
/// <summary>
/// Represents a tool that performs integer subtraction using two integer inputs.
/// </summary>
public sealed class SubtractionTool : ITool
{
    /// <summary>
    ...
    {
        get { return "Subtracts integer b from integer a and returns the result."; }
    }

    /// <summary>
    /// Invokes the subtraction tool with two integer arguments: 'a' and 'b'.
    /// </summary>
