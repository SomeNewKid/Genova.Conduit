...
/// <item>
/// <description>
/// <c>"format"</c> – a .NET date/time format string.
/// Defaults to the round-trip format specifier <c>"O"</c>.
/// </description>
/// </item>
/// </list>
/// </remarks>
[CodeQuality(Public = true, Justification = "Intended for use by libraries and applications.")]
public sealed class LocalDateTimeTool : ITool
{
    ...
    {
        get { return "Returns the current date and time as a formatted string."; }
    }
    ...
    /// </param>
    /// <returns>
    /// A task whose result is a string representing the current date and time.
    /// </returns>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // This simple tool returns the formatted string and does not modify the context.
    ...
    private static DateTime GetNow(IDictionary<string, object?> arguments)
    {
        ...
        // Default to local time if argument is missing or unrecognized.
        return DateTime.Now;
    }
    ...
    private static string GetFormat(IDictionary<string, object?> arguments)
    {
        ...
        // Round-trip date/time pattern by default.
        return "O";
    }
}
